...
csv_header = ['KA', 'Error', 'Composition'] 
csv_data = []

# Folder names
download_folder = input("Enter the target folder path:\n") #"/Users/jiamingxu/Downloads/"
...
for folder in folders:
    ...
    ka = get_ka()
    csv_data.append(ka + [folder] )
    os.chdir("../../")

with open('ka_.csv', 'w', encoding='UTF8', newline='') as f:
    writer = csv.writer(f)
